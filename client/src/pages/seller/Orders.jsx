...
const Orders = () => {
  ...
  return (
    ...
    {orders.map((order, index) => (
        <div key={index} className="flex flex-col  md:items-center md:md:flex-row justify-between gap-5 p-5 max-w-4xl rounded-md border border-gray-300 text-gray-800">
            ...
            <div className="md:text-base text-black/60">
